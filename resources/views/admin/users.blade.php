        ...
        <table class="w-full text-sm min-w-[760px]">
            <thead class="bg-gray-50 border-b border-gray-100">
                <tr>
                    ...
                    <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 w-24">Role</th>
                    <th class="text-center px-5 py-3 text-xs font-semibold text-gray-500 w-28">Status</th>
                    ...
                    <td class="px-5 py-3">
                        <div class="flex items-center justify-center gap-1">
                            ...
                            <form
                                ...
                                <button
                                    class="text-xs text-amber-500 hover:text-amber-700 px-2 py-1 rounded hover:bg-amber-50"
            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        required
                        minlength="6"
                        class="w-full border border-gray-300 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                </div>
